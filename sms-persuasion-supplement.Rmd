...
Github repository for this site can be found [here](https://github.com/heinonmatti/sms-persuasion/), the index page for this small site is [here](https://heinonmatti.github.io/sms-persuasion/index.html).
...
(NOTE: the prior graph is with BF01 instead of BF10):
