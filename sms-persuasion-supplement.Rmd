...
So, the BF10 of the order against null is `r bf_restriction_against_null %>% round(4)` and the BF01 is `r 1/bf_restriction_against_null %>% round(4)`.
